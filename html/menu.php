  ...
  <div class="container-fluid containernav" style="margin: 0px 45px;">
    <a class="navbar-brand" href="index.php">
      <div class="row justify-content-center align-items-center">
        <span class="h-8 logomenu" style="font-weight: bold; color: #333;">Fastpack Industrial</span>
      </div>
    </a>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      <div class="offcanvas-header">
        <span class="offcanvas-title" style="width: 80%; font-weight: bold;">Fastpack Industrial</span>
